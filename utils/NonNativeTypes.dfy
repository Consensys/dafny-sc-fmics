...
module NonNativeTypes {
    ...
    */
   type uint128 = i:nat | 0 <= i < 0x1_0000_0000_0000_0000_0000_0000_0000_0000
   const MAX_UINT128: nat := (0x1_0000_0000_0000_0000_0000_0000_0000_0000 as nat - 1) 

   /**
    * @note: 10 sections of 16 bits (20 bytes) 0x0000
    */
   type uint160 = i:nat | 0 <= i < 0x1_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000
    ...
    */
   type uint256 = i:nat | 0 <= i < 0x1_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000  //witness 0
